...
public interface ServiceHelper {
    ...
    // ====== 数据库中对应的字段号 ======= //
    String NURSE_INFO_TABLE_NAME = "NurseInfo";
    String NURSE_ID = "nurse_id";
    String NURSE_GENDER = "nurse_gender";
    String NURSE_PASSWORD = "password";
    String NURSE_AGE = "nurse_age";
    String NURSE_MAJOR = "nurse_major";
    String NURSE_NAME = "nurse_name";
    String NURSE_PHOTO = "nurse_photo";

    String HOUSE_INFO_TABLE_NAME = "HouseInfo";
    String HOUSE_ID = "house_id";
    String HOUSE_STATE = "house_state";

    String BED_INFO_TABLE_NAME = "BedInfo";
    String BED_ID = "bed_id";
    String BED_STATE = "bed_state";

    String PATIENT_INFO_TABLE_NAME = "PatientInfo";
    ...
    String ID = "id";
    String TEMPER_INFO_TABLE_NAME = "TemperatureInfo";
